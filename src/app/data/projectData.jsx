export const homepageData = [
  {
    ...
    contribution: ["단독 개발자로서 프로젝트 전 범위(UI, 기능, CMS 연동) 담당"],
    role: [
      "웹 UI 개발 (메인/서브 페이지)",
...
export const ecatalogData = [
  {
    ...
    contribution: ["단독 개발자로서 프로젝트 전 범위(UI, 기능, 인터랙션) 담당"],
    role: [
...
export const sideProjectData = [
  {
    thumb: "pokedex",
    link: "https://uniburepokedex.vercel.app/",
    project: "포켓몬 도감 웹사이트 | 1주 개발",
    stack: "React, Tailwind CSS, Framer Motion, PokeAPI",
    contribution: ["100%"],
    role: [
      "UI 개발 및 인터랙션 구현",
      "데이터 조회 및 검색 기능 개발",
    ...
    description: [
      "PokeAPI를 활용해 1세대 포켓몬 정보를 조회할 수 있는 도감 서비스",
      "검색 및 타입 기반 필터링을 통해 원하는 포켓몬을 빠르게 탐색",
      "무한 스크롤 로딩을 적용해 연속적인 탐색 경험 제공",
      "애니메이션 및 반응형 UI로 사용자 경험 향상",
    ],
  },
];
